...
public class VelocityUtils {
    ...
    public static List<String> getTemplateListPlus(String tplCategory, String header) {
        ...
        templates.add(header + "/js/api.js.vm");
        if (GenConstants.TPL_CRUD.equals(tplCategory)) {
            templates.add(header + "/vue/index.vue.vm");
        } else if (GenConstants.TPL_TREE.equals(tplCategory)) {
            templates.add(header + "/vue/index-tree.vue.vm");
        } else if (GenConstants.TPL_SUB.equals(tplCategory)) {
            templates.add(header + "/vue/index.vue.vm");
            templates.add(header + "/java/sub-domain.java.vm");
        }
        return templates;
    }
